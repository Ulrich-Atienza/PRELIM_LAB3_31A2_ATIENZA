...
namespace Inherit_InterFace.Controllers
{
    public class HomeController : Controller
    {
        public IActionResult Index()
        {
            ...
            customers.Add(new VipCustomer { CustomerId = 7, FirstName = "Petrus", MiddleName = "E.", LastName = "Sartorius", Birthday = new DateTime(1980, 7, 7) });
            customers.Add(new VipCustomer { CustomerId = 8, FirstName = "Antipho", MiddleName = "L.", LastName = "Tyrannus", Birthday = new DateTime(1988, 1, 12) });
